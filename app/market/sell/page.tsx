  ...
  return (
    <main style={pageStyle}>
      <header style={headerStyle}>
        <div>
          <h1 style={titleStyle}>Табло Продава</h1>

          <p style={subtitleStyle}>
            Активни предложения за продажба на електроенергия
          </p>
        </div>
      ...
      <div style={tabsStyle}>
        <Link href="/market/buy" style={tabLinkStyle}>
          🛒 Купува
        </Link>
            ...
            <div style={mainRowStyle}>
              ...
              <div>
                <h2 style={cardTitleStyle}>
                  {auction.title || "Продажба на ел. енергия"}
                </h2>

                <p style={companyStyle}>
                  {auction.sector || "Производител"} 🔵
                </p>
              </div>
            </div>
